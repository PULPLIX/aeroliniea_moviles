...
public class ServicioVuelo extends Servicio {
    ...
    private static final String FILTRAR_VUELODESCUENTO = "{?=call FILTRAR_VUELODESCUENTO(?,?,?,?,?)}";
    ...
    public ArrayList filtrarVuelo(String Modalidad, String idOrigen, String idDestino, String fechaI, String fechaF) throws GeneralException, DbException {
        ...
        public ArrayList filtrarVueloDescuento(String Modalidad, String idOrigen, String idDestino, String fechaI, String fechaF) throws GeneralException, DbException {
        ...
        try {
            toDo = conexion.prepareCall(FILTRAR_VUELODESCUENTO);
            toDo.registerOutParameter(1, OracleTypes.CURSOR);
            toDo.setString(2, Modalidad);
            toDo.setString(3, idOrigen);
            toDo.setString(4, idDestino);
        ...
        if (Vuelo == null) {
            throw new DbException("El vuelo no existe");
        }
