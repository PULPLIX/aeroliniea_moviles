...
<t:admin>
    ...
    <jsp:body>
        ...
        <div class="row my-3">
            <div class="col-sm-6">
                <h1 class="display-6 fw-normal text-negro"><i class="fas fa-map-marked-alt text-primary"></i> &nbsp;Gestión de rutas </h1>
            </div>
        </div>
        <div class="row  border-bottom">
            <div class="col-6 ">
                <div class="card">
                    <div class="card-header titulo"><i class="fas fa-plus"></i> &nbsp;Agregar ruta</div>
                    <div class="card-body d-flex justify-content-center">
                        <div class="card-body d-flex justify-content-center">
                            <div class=" w-100">
                                <div class="input-group mb-3 w-100">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class=" card-header titulo mb-2">
                        <span><i class="fas fa-bars"></i> &nbsp;Listado de rutas</span>
                    </div>
                    <!-- /.card-body -->
